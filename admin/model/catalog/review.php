...
class ModelCatalogReview extends Model {
	...
	public function deleteReviewz($reviewz_id) {
		$this->db->query("DELETE FROM " . DB_PREFIX . "reviewz WHERE reviewz_id = '" . (int)$reviewz_id . "'");
	}
	...
	public function editStatus($reviewz_id, $status) {
		$query = "UPDATE " . DB_PREFIX . "reviewz SET status = '" . $this->db->escape($status[0]) . "'  WHERE reviewz_id = '" . (int)$reviewz_id . "'";
		$this->db->query($query);
	}
	
	public function getReviewz($data = array()) {
		$sql = "SELECT * FROM " . DB_PREFIX . "reviewz ";
	...
	public function getTotalReviewz($data = array()) {
		$sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "reviewz";
