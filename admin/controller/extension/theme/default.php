...
class ControllerExtensionThemeDefault extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['product_limit_mobile'])) {
			$data['error_product_limit_mobile'] = $this->error['product_limit_mobile'];
		} else {
			$data['error_product_limit_mobile'] = '';
		}
		...
		if (isset($this->request->post['theme_default_product_limit_mobile'])) {
			$data['theme_default_product_limit_mobile'] = $this->request->post['theme_default_product_limit_mobile'];
		} elseif (isset($setting_info['theme_default_product_limit_mobile'])) {
			$data['theme_default_product_limit_mobile'] = $setting_info['theme_default_product_limit_mobile'];
		} else {
			$data['theme_default_product_limit_mobile'] = 15;
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['theme_default_product_limit_mobile']) {
			$this->error['product_limit_mobile'] = $this->language->get('error_limit_mobile');
		}
