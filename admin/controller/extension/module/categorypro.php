...
class ControllerExtensionModuleCategorypro extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/categorypro', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['action'] = $this->url->link('extension/module/categorypro', 'user_token=' . $this->session->data['user_token'], true);
		...
		$this->response->setOutput($this->load->view('extension/module/categorypro', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/categorypro')) {
