...
class ControllerKbmpMarketplacePaypalPayout extends Controller {
    ...
    public function index() {
        ...
        $data['heading_subtitle'] = $this->language->get('text_kbmp_paypal_payout_settings');
        ...
        if (VERSION < 2.2) {
            $this->response->setOutput($this->load->view('kbmp_marketplace/paypal_payout.tpl', $data));
        } else {
