...
class ControllerKbmpMarketplaceSellersReviewApprovalList extends Controller {
    ...
    public function index() {
        ...
        $this->load->language('kbmp_marketplace/sellers_review_approval_list');
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('kbmp_marketplace/sellers_review_approval_list', $this->session_token_key.'=' . $this->session_token . $url, true)
        );
        ...
        $sellers_reviews_total = $this->model_kbmp_marketplace_kbmp_marketplace->getTotalPendingSellersReviews($filter_data);

        $data['sellers_reviews_total'] = $sellers_reviews_total;
        
        $results = $this->model_kbmp_marketplace_kbmp_marketplace->getPendingSellersReviews($filter_data);
        ...
        $pagination->url = $this->url->link('kbmp_marketplace/sellers_review_approval_list', $this->session_token_key.'=' . $this->session_token . $url . '&page={page}', true);
        ...
        $active_tab['active_tab'] = 14;
        $data['tab_common'] = $this->load->controller($this->module_path . '/kbmp_marketplace/common', $active_tab);
        
        
        if (VERSION < 2.2) {
            $this->response->setOutput($this->load->view('kbmp_marketplace/sellers_review_approval_list.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('kbmp_marketplace/sellers_review_approval_list', $data));
        }
