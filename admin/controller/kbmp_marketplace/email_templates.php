...
class ControllerKbmpMarketplaceEmailTemplates extends Controller {
    ...
    protected function getList() {
        ...
        $data['heading_subtitle'] = $this->language->get('text_kbmp_email_templates');
        $this->load->language('kbmp_marketplace/email_templates');
        $this->load->language('kbmp_marketplace/common');
        ...
        if (VERSION < 2.2) {
            $this->response->setOutput($this->load->view('kbmp_marketplace/email_templates.tpl', $data));
        }else{
    ...
    public function edit() {
        ...
        if (VERSION < 2.2) {
            $this->response->setOutput($this->load->view('kbmp_marketplace/email_template_edit.tpl', $data));
        } else {
