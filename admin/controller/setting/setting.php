...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['wa'])) {
			$data['error_wa'] = $this->error['wa'];
		} else {
			$data['error_wa'] = '';
		}
		
		if (isset($this->error['tg'])) {
			$data['error_tg'] = $this->error['tg'];
		} else {
			$data['error_tg'] = '';
		}
      ...
      if (isset($this->request->post['config_textv'])) {
			$data['config_textv'] = $this->request->post['config_textv'];
		} else {
			$data['config_textv'] = $this->config->get('config_textv');
		}
      
        if (isset($this->request->post['config_textn'])) {
			$data['config_textn'] = $this->request->post['config_textn'];
		} else {
			$data['config_textn'] = $this->config->get('config_textn');
		}
		
		if (isset($this->request->post['config_rekv'])) {
			$data['config_rekv'] = $this->request->post['config_rekv'];
		} else {
			$data['config_rekv'] = $this->config->get('config_rekv');
		}
		
		if (isset($this->request->post['config_buyer_content'])) {
			$data['config_buyer_content'] = $this->request->post['config_buyer_content'];
		} else {
			$data['config_buyer_content'] = $this->config->get('config_buyer_content');
		}
		
		if (isset($this->request->post['config_seller_content'])) {
			$data['config_seller_content'] = $this->request->post['config_seller_content'];
		} else {
			$data['config_seller_content'] = $this->config->get('config_seller_content');
		}
		...
		if (isset($this->request->post['config_buyer_email'])) {
			$data['config_buyer_email'] = $this->request->post['config_buyer_email'];
		} else {
			$data['config_buyer_email'] = $this->config->get('config_buyer_email');
		}
		...
		if (isset($this->request->post['config_tg'])) {
			$data['config_tg'] = $this->request->post['config_tg'];
		} else {
			$data['config_tg'] = $this->config->get('config_tg');
		}
		...
		if (isset($this->request->post['config_formText'])) {
			$data['config_formText'] = $this->request->post['config_formText'];
		} else {
			$data['config_formText'] = $this->config->get('config_formText');
		}
	...
	protected function validate() {
		...
		if (utf8_strlen($this->request->post['config_wa']) < 3) {
			$this->error['wa'] = $this->language->get('error_wa');
		}
		
		if (utf8_strlen($this->request->post['config_tg']) < 3) {
			$this->error['tg'] = $this->language->get('error_tg');
		}
