...
$_['entry_menu']       		 = 'Выводить оглавление';
$_['entry_layout']           = 'Изменить макет';
$_['entry_param']            = 'Выводить список ссылок по параметру';
...
$_['help_doc']            	 = 'Данная статья является документом?';
$_['help_noindex']           = 'Индексация в поисковых системах Google, Yandex, Bing и других';
$_['help_param']             = 'Если да, укажите системное название параметра - уточните у разработчика какое';
$_['help_menu']              = 'В начале статьи будет выводиться автоматическое оглавление для удобного перехода';
