...
class __TwigTemplate_e3303e28dbcc51067be0800ef5870ede499b8e10a184bfb50ba6a39dcde32767 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"{{ file_links[custom_field.id_field] }}\">Скачать файл</a>
\t\t\t\t\t\t\t\t\t\t\t\t\t{% endif %}
\t\t\t\t\t\t\t\t\t\t\t\t{% if error_seller_field[custom_field.id_field] %}
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"text-danger\">{{ error_seller_field[custom_field.id_field] }}</div>
\t\t\t\t\t\t\t\t\t\t\t\t{% endif %}</div>
