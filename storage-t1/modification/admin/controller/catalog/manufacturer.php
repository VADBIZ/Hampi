...
class ControllerCatalogManufacturer extends Controller {
    ...
    // SEO URL Generator FREE . begin
		...
		$data['manufacturer_id'] = isset($this->request->get['manufacturer_id']) ? $this->request->get['manufacturer_id'] : false;
		...
		if (isset($this->request->get['manufacturer_id'])) {
			if (isset($this->request->post['seo_url_generator_redirects'])) {
				...
				$data['redirects'] = $this->model_extension_module_seo_url_generator->getRedirects('manufacturer_id', $this->request->get['manufacturer_id']);
			}
		} else {
