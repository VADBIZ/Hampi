		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (isset($this->request->get['page'])) {
				$url .= '&page=' . $this->request->get['page'];
                    ...
                    if (isset($this->request->get['redirect']) && $this->request->get['redirect'] == 'products_review') {
                        $this->response->redirect($this->url->link('kbmp_marketplace/products_review', 'user_token=' . $this->session->data['user_token'], true));
                    }
