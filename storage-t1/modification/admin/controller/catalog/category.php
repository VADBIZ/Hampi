...
//		if (isset($this->error['meta_front'])) {
//			$data['error_meta_front'] = $this->error['meta_front'];
//		} else {
//			$data['error_meta_front'] = array();
//		}
...
//			if ((utf8_strlen($value['meta_front']) < 0) || (utf8_strlen($value['meta_front']) > 255)) {
//				$this->error['meta_front'][$language_id] = $this->language->get('error_meta_front');
//			}
		}
