...
class ControllerCatalogInformation extends Controller {
    ...
    // SEO URL Generator FREE . begin
		...
		if (isset($this->request->post['param'])) {
			...
			$data['param'] = $information_info['param'];
		} else {
			$data['param'] = '';
		}
		...
		$data['information_id'] = isset($this->request->get['information_id']) ? $this->request->get['information_id'] : false;
