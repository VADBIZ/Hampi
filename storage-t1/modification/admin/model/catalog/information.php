...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "information SET sort_order = '" . (int)$data['sort_order'] . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', menu = '" . (isset($data['menu']) ? (int)$data['menu'] : 0) . "', doc = '" . (isset($data['doc']) ? (int)$data['doc'] : 0) . "',param = '" . (isset($data['param']) ? $data['param'] : 0) . "', status = '" . (int)$data['status'] . "', noindex = '" . (int)$data['noindex'] . "'");
		...
		foreach ($data['information_seo_url'] as $store_id => $store) {
			foreach ($store as $language_id => $url) {
				if (empty($data['information_seo_url'][$store_id][$language_id])) {
					$sug_data = array(
						'name'            =>$data['information_description'][$language_id]['title'],
	...
	public function editInformation($information_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "information SET sort_order = '" . (int)$data['sort_order'] . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', menu = '" . (isset($data['menu']) ? (int)$data['menu'] : 0) . "', doc = '" . (isset($data['doc']) ? (int)$data['doc'] : 0) . "', param = '" . (isset($data['param']) ? $data['param'] : 0) . "', status = '" . (int)$data['status'] . "', noindex = '" . (int)$data['noindex'] . "' WHERE information_id = '" . (int)$information_id . "'");
