	...
	public function index() {
		...
		if ($affiliate_info) {		
			...
			$this->load->model('setting/kbmp_marketplace');
                        $this->load->language('kbmp_marketplace/account_page_lang');  
				...
				$data['text_seller'] = $this->language->get('text_seller');
		                ...
		                $data['payout_request'] = $this->url->link('kbmp_marketplace/payoutRequest', '', true);
		                $data['product_import'] = $this->url->link('kbmp_marketplace/product_import', '', true);
		                $data['product_return'] = $this->url->link('kbmp_marketplace/return', '', true);
		                $data['coupons'] = $this->url->link('kbmp_marketplace/coupon', '', true);
		                $data['downloads'] = $this->url->link('kbmp_marketplace/download', '', true);
		                $data['support'] = $this->url->link('kbmp_marketplace/support', '', true);
