...
$_['button_next']                  = 'Вход';
$_['text_new_customer']            = 'Миссия Hampi—выступать гарантом в сделке между компаниями';
...
$_['text_forgotten']               = 'Восстановить';
$_['text_forgotten_label']         = 'Забыли пароль?';
...
$_['error_email_wrong']                  = 'E-Mail указан неверно!';
$_['error_password_empty']                  = 'Пароль не может быть пустым!';
...
$_['text_rules']               = 'Соглашаюсь с условиями <a href="/policy.pdf" target="_blank">Правил пользования торговой площадкой и правилами возврата</a>';
$_['error_rules']               = 'Пожалуйста, согласитесь с условиями!';