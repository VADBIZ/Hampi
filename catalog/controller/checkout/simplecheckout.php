...
class ControllerCheckoutSimpleCheckout extends SimpleController {
    ...
    public function index($args = null) {
		...
		$this->_templateData['link_cart'] = $this->url->link('checkout/cart');
        ...
        if (!$this->simplecheckout->isAjaxRequest() && !$this->_templateData['popup'] && !$this->_templateData['as_module']) {
            ...
            $this->_templateData['simple_header'] = $this->load->controller('common/header');
            $this->_templateData['simple_footer'] = $this->load->controller('common/footer');
        }
