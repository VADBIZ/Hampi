...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		if (isset($this->request->get['search'])) {
			$data['heading_title_search'] = $this->language->get('heading_title') .  ': ' . $this->request->get['search'];
		} else {
			$data['heading_title_search'] = $this->language->get('heading_title');
		}
		
		$data['breadcrumbs'][] = array(
			'text' => $data['heading_title_search'],
