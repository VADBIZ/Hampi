...
class ControllerKbmpMarketplaceReturn extends Controller {
    ...
    public function __construct($params) {
        ...
        $this->model_kbmp_marketplace_kbmp_marketplace->getSellerLoggedStatus($this->url->link('kbmp_marketplace/return', '', true));
    }
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            //start by dharmanshu 6-02-2021 for the product return issue
            //$this->model_sale_return->addReturn($this->request->post);
            $this->model_kbmp_marketplace_kbmp_marketplace->addReturn($this->request->post);

            //end by dharmanshu 6-02-2021 for the product return issue
