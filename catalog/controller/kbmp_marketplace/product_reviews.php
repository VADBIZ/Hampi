...
class ControllerKbmpMarketplaceProductReviews extends Controller {
    ...
    public function __construct($params) {
        ...
        $this->model_kbmp_marketplace_kbmp_marketplace->getSellerLoggedStatus($this->url->link('kbmp_marketplace/product_reviews', '', true));
    }
    ...
    protected function getList() {
        ...
        foreach ($results as $result) {
            ...
            $data['reviews'][] = array(
                ...
                'comment' => substr($result['text'], 0, 100)."...",
                'comment_full' => $result['text'],
