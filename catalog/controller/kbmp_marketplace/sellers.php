...
class ControllerKbmpMarketplaceSellers extends Controller {
    ...
    public function index() {
        ...
        /* Starts Changes done by Mahima on 22nd April 2020 for adding search fields in sellers page and sellers profile */
        //filters
        $data['filter_by'] = $this->language->get('filter_by');
        $data['filter_by_none'] = $this->language->get('filter_by_none');
        $data['filter_by_products'] = $this->language->get('filter_by_products');
        $data['filter_by_sellers'] = $this->language->get('filter_by_sellers');
        $data['filter_segment'] = $this->language->get('filter_segment');
        $data['filters'] = $this->language->get('filters');
        $data['filter_criteria'] = $this->language->get('filter_criteria');
        ...
        foreach ($results as $result) {
            if (VERSION >= 3.0) {
                if (!empty($result['logo'])) {
                    ...
                    $image = $this->model_tool_image->resize('sellers_logo/no_image.png', $this->config->get('theme_' . $this->config->get('config_theme') . '_image_product_width'), $this->config->get('theme_' . $this->config->get('config_theme') . '_image_product_height'));
                }
            } else {
                if (!empty($result['logo'])) {
                    $image = $this->model_tool_image->resize('sellers_logo/' . $result['logo'], $this->config->get($this->config->get('config_theme') . '_image_product_width'), $this->config->get($this->config->get('config_theme') . '_image_product_height'));
                } else {
                    $image = $this->model_tool_image->resize('sellers_logo/no_image.png', $this->config->get($this->config->get('config_theme') . '_image_product_width'), $this->config->get($this->config->get('config_theme') . '_image_product_height'));
                }
            }
        ...
        if (version_compare(VERSION, '2.2.0.0', '<')) {
            $this->response->setOutput($this->load->view('default/template/kbmp_marketplace/sellers.tpl', $data));
        } else {
    ...
    public function view() {
        ...
        $data['filtering_by'] = $filter_by;
        $data['filtering_text'] = $filter_text;
        /* Ends Changes done by Mahima on 22nd April 2020 for adding search fields in sellers page and sellers profile */
        ...
        $seller = $this->model_kbmp_marketplace_kbmp_marketplace->getSeller($this->request->get['seller_id'], 1);
        ...
        if (isset($seller) && !empty($seller)) {
            if (VERSION >= 3.0) {
                ...
                if (!empty($seller['logo'])) {
                    $image = $this->model_tool_image->resize('sellers_logo/' . $seller['logo'], $this->config->get($this->config->get('config_theme') . '_image_product_width'), $this->config->get($this->config->get('config_theme') . '_image_product_height'));
                } else {
                    $image = $this->model_tool_image->resize('sellers_logo/no_image.png', $this->config->get($this->config->get('config_theme') . '_image_product_width'), $this->config->get($this->config->get('config_theme') . '_image_product_height'));
                }
            }
            ...
            if (!empty($seller['banner'])) {
                ...
                $banner = $this->model_tool_image->resize('sellers_banner/seller_banner.png', '1300', '280');
            }
            ...
            $this->response->redirect($this->url->link('kbmp_marketplace/sellers', '', true));
        }
        ...
        if (version_compare(VERSION, '2.2.0.0', '<')) {
            $this->response->setOutput($this->load->view('default/template/kbmp_marketplace/seller_view.tpl', $data));
        } else {
    ...
    public function reviews() {
        ...
        if (isset($seller_reviews) && !empty($seller_reviews)) {
            foreach ($seller_reviews as $seller_review) {
                $data['seller_reviews'][] = array(
                    ...
                    'comment' => nl2br($seller_review['text']),
        ...
        if (isset($seller) && !empty($seller)) {
            ...
            if (!empty($seller['banner'])) {
                ...
                $banner = $this->model_tool_image->resize('sellers_banner/seller_banner.png', '1140', '380');
            }
