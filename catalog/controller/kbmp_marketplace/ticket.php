...
//        var_dump($customer);die;
        ...
        if (version_compare(VERSION, '2.2.0.0', '<')) {
            $this->response->setOutput($this->load->view('default/template/kbmp_marketplace/ticket_form.tpl', $data));
        } else {
    ...
    public function checkTicket() {
        ...
        if (version_compare(VERSION, '2.2.0.0', '<')) {
            $this->response->setOutput($this->load->view('default/template/kbmp_marketplace/checkTicket.tpl', $data));
        } else {
    ...
    public function checkAllTicket() {
        ...
        if (version_compare(VERSION, '2.2.0.0', '<')) {
            $this->response->setOutput($this->load->view('default/template/kbmp_marketplace/checkAllTicket.tpl', $data));
        } else {
    ...
    public function viewTicket() {
        ...
        if (version_compare(VERSION, '2.2.0.0', '<')) {
            $this->response->setOutput($this->load->view('default/template/kbmp_marketplace/viewTicket.tpl', $data));
        } else {
