...
class ControllerKbmpMarketplaceCategoryRequest extends Controller {
    ...
    public function __construct($params) {
        ...
        $this->model_kbmp_marketplace_kbmp_marketplace->getSellerLoggedStatus($this->url->link('kbmp_marketplace/category_request', '', true));
    }
    ...
    protected function getList() {
        ...
        if (version_compare(VERSION, '2.2.0.0', '<')) {
            $this->response->setOutput($this->load->view('default/template/kbmp_marketplace/category_request.tpl', $data));
        } else {
