...
class ControllerKbmpMarketplaceSupport extends Controller {
    ...
    public function index() {
        ...
        if (version_compare(VERSION, '2.2.0.0', '<')) {
            $this->response->setOutput($this->load->view('default/template/kbmp_marketplace/support.tpl', $data));
        } else {
    ...
    public function ticket() {
        ...
        if (!empty($ticket_data)) {
            ...
            } else if ($ticket_data['priority'] == '2') {
                $data['priority'] = $this->language->get('text_medium');
            } else if ($ticket_data['priority'] == '3') {
        ...
        $data['header'] = $this->load->controller('kbmp_marketplace/header');
        $data['footer'] = $this->load->controller('kbmp_marketplace/footer');

        if (version_compare(VERSION, '2.2.0.0', '<')) {
            $this->response->setOutput($this->load->view('default/template/kbmp_marketplace/ticket_view.tpl', $data));
        } else {
