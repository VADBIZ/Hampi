...
class ControllerKbmpMarketplaceTransactions extends Controller {
    ...
    public function __construct($params) {
        ...
        $this->model_kbmp_marketplace_kbmp_marketplace->getSellerLoggedStatus($this->url->link('kbmp_marketplace/transactions', '', true));
    }
    ...
    protected function getList() {
        ...
        if (version_compare(VERSION, '2.2.0.0', '<')) {
            $data['footer'] = $this->load->view('default/template/kbmp_marketplace/footer.tpl', $data);
        } else {
        ...
        foreach ($results as $result) {
            ...
            $data['transactions'][] = array(
                ...
                'type' => isset($result['transaction_type']) && $result['transaction_type'] == '1' ? $this->language->get('text_credit') : $this->language->get('text_debit'),
        ...
        if (version_compare(VERSION, '2.2.0.0', '<')) {
            $this->response->setOutput($this->load->view('default/template/kbmp_marketplace/transactions.tpl', $data));
        } else {
